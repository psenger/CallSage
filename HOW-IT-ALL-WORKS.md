...
```
Input:  example-insurance-PDS.pdf (1.1 MB)
Output: "Insurance Policy\n\nCoverage\nThis policy covers..."
...
2. Each chunk gets metadata:
   - `source`: Original filename (`example-insurance-PDS.pdf`)
...
Chunk 0:
{
  ...
  "metadata": {
    "source": "example-insurance-PDS.pdf",
    "chunk_index": 0,
    "chunk_count": 408,
    "file_type": ".pdf",
    "ingested_at": "2026-02-03T05:19:19.704524"
  },
  "id": "example-insurance-PDS.pdf_0"
}
```
...
├── Chunk IDs:     ["example-policy...pdf_0", "example-policy...pdf_1", ...]
├── Embeddings:    [[0.023, -0.154, ...], [0.045, 0.231, ...], ...]
├── Content:       ["This policy covers...", "Exclusions include...", ...]
└── Metadata:      [{"source": "example-policy...pdf", ...}, {...}, ...]
```
...
│    "sources": [                                         │
│      {                                                  │
│        "document": "example-insurance-PDS.pdf",        │
│        "chunk_id": "example-policy...pdf_12",                   │
│        "relevance": 0.92                                │
│      },                                                 │
│      ...4 more sources                                  │
│    ],                                                   │
...
```python
{
    "ids": [["example-policy...pdf_12", "example-policy...pdf_45", ...]],
    "documents": [["Coverage: This policy covers...", "Benefits include...", ...]],
    "metadatas": [[{"source": "example-policy...pdf", ...}, {...}, ...]],
...
```json
{
  ...
  "sources": [
    {
      "document": "example-insurance-PDS.pdf",
      "chunk_id": "example-insurance-PDS.pdf_12",
      "relevance": 0.92
    },
    {
      "document": "example-insurance-PDS.pdf",
      "chunk_id": "example-insurance-PDS.pdf_45",
      "relevance": 0.88
    },
    {
      "document": "example-insurance-PDS.pdf",
      "chunk_id": "example-insurance-PDS.pdf_67",
      "relevance": 0.85
    },
    {
      "document": "example-insurance-PDS.pdf",
      "chunk_id": "example-insurance-PDS.pdf_89",
      "relevance": 0.82
    },
    {
      "document": "example-insurance-PDS.pdf",
      "chunk_id": "example-insurance-PDS.pdf_102",
      "relevance": 0.79
    }
  ],
  "fallback_used": false,
...
```
Document: "Insurance Policy. Coverage includes medical expenses..."

chunk_size=200:
  Chunk 1: "Insurance Policy. Coverage includes..."
  Chunk 2: "medical expenses up to $50,000 with..."
  → 800 chunks (very granular)

chunk_size=500:
  Chunk 1: "Insurance Policy. Coverage includes medical expenses up to $50,000 with $500 excess..."
  → 408 chunks (balanced) ⭐

chunk_size=1000:
  Chunk 1: "Insurance Policy. Coverage includes medical expenses up to $50,000 with $500 excess. Exclusions: Pre-existing conditions..."
...
curl -X POST http://localhost:8000/summarize \
  -H "Content-Type: application/json" \
  -d '{
    "document_ids": ["example-policy...pdf_0", "example-policy...pdf_1"],
    "max_length": 200
  }'
```
